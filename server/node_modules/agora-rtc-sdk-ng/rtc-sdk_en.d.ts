 ...
 * @param url The URL address of the media stream.
 *
 * @asMemberOf IAgoraRTCClient
 * @event
 */
...
export declare interface IAgoraRTC {
     ...
     * @ignore
     */
    loadModule(plugin: any, moduleOption?: any): void;
}
...
export declare interface IAgoraRTCClient extends EventEmitter {
     ...
     * @param secret The encryption secret. Agora recommends you use OpenSSL to generate the secret on your server. For details, see [Media Stream Encryption](https://docs.agora.io/en/Video/channel_encryption_web_ng?platform=Web).
 ...
 * - `"vp8"`: Use VP8 for encoding.
 * - `"h264"`: Use H.264 for encoding.
 * - `"vp9"`: Reserved, unavailable now.
 * - `"av1"`: Reserved, unavailable now.
 *
 * > Safari 12.1 or earlier does not support the VP8 codec.
 */
export declare type SDK_CODEC = "h264" | "vp8" | "vp9" | "av1";
...
declare const SUPPORT_SVC_CONFIG_LIST: {
    "1SL1TL": SVCConfiguration;
    "3SL3TL": SVCConfiguration;
    "2SL3TL": SVCConfiguration;
};
...
/**
 * Specifies a constraint for a property, such as the number of layers in spatial and temporal [[SVCConfiguration]].
 */
export declare interface SVCConfiguration {
    /**
     * The number of spatial layer in SVC.
     */
    numSpatialLayers: 1 | 2 | 3;
    /**
     * The number of temporal layer in SVC.
     */
