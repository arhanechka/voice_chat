...
function Call() {
  ...
  const [ token, setToken ] = useState('00668f8df76ddf14870b06c08f45c749885IABPf5MfAppVI5qqvyM9qZreN2Ip6SlaXpMHaDNAaBPNY9dZvPUAAAAAEACZZ/CeSRENYQEAAQBJEQ1h');
    ...
    <div className='call'>
      ...
      <div className='player-container'>
        <div className='local-player-wrapper'>
          ...
          <MediaPlayer videoTrack={undefined} audioTrack={localAudioTrack}></MediaPlayer>
        </div>
